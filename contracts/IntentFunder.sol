...
<<<<<<< HEAD
     ...
     * @dev Required to handle native currency that may be sent during contract creation
     *      or during the funding process. Any received ETH will be forwarded to the reward
