...
import {Executor} from "../contracts_forge/Executor.sol";
...
contract Deploy is Script {
    ...
    // Static salt for the Executor contract since it shouldn't need to be redeployed
    bytes32 constant EXECUTOR_SALT = keccak256("Kernel3.1Executor");
    ...
    function run() external {
        ...
        VerificationData[4] memory contracts = [
            ...
            VerificationData({
                ...
                contractPath: "contracts_forge/Executor.sol:Executor",
                constructorArgs: new bytes(0),
                chainId: block.chainid
            })
        ];
